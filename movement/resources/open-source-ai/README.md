# Open Source AI Labs & Grassroots Models
...
**AI infrastructure can be green.** LAION explicitly advocates for reusing existing computational resources rather than building new data centers. This connects directly to the green infrastructure research — open models + waste-heat compute = community-owned AI that heats your apartment.

## Projects

### Kyutai
Europe's first privately funded, independent open-science AI research lab, based in Paris. Releases state-of-the-art multimodal models and training datasets for the common good.
- https://kyutai.org

### LAION
German volunteer-driven non-profit providing massive open-source datasets to democratize machine learning. Advocates for environmentally friendly reuse of existing compute.
- https://laion.ai

### Silo AI
Finnish AI lab leading Europe's largest open-source AI initiative. Uses the LUMI supercomputer to build sovereign, multilingual open models (like Poro) for European languages.
- https://silo.ai

### OpenEuroLLM
Collaborative project building transparent, compliant, and fully open foundation models tailored to European linguistic and cultural diversity.
- https://openeurollm.eu

### GFOSS
Greek Free and Open Source Software Society. Advocates for low-cost, green, open-source AI frameworks to ensure technological sovereignty and empower local communities.
- https://gfoss.eu
